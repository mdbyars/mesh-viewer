...
//global last x position and y position of mouse 
double gxpos, gypos;

//code from example linked in assignment OpenGL-tutorial 
...
static void mouse_button_callback(GLFWwindow* window, int button, int action, int mods)
{
    ...
    float dist = sqrt(pow(xpos, 2)+ pow(ypos, 2));
    //save xpos in glaobal var when the mouse moves then you can change 
    //help here ?? how to calculate rotation 
    /* 
    ...
    */
    ...
    glm::mat4 camera = glm::lookAt(vec3(-1, -1, -1), glm::vec3(0, 0, 0), glm::vec3(1, 1, 1));
    
    glm::lookAt(vec3(0, 0, 0), vec3(0, 0, 0), vec3(0, 0, 0));
...
{
    // TODO: CAmera controls use this to calculate rotation 0 3 dont vhange your angle more than .1 use global variable print out to sanity check 
...
int main(int argc, char** argv)
{
    ...
    // help here crashes when uncommented 
    int numTriangles = 3;
    GLuint vboPosId;
